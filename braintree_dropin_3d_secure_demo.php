...
<script type="text/javascript">
    ...
    BTFn.sendJSON = function($pay_btn) {
        ...
        $.ajax({
            ...
            url: "braintree_dropin_3d_secure_demo.php",
        ...
        braintree.setup(
            ...
            'dropin', {
                ...
                onPaymentMethodReceived:function(obj){
					...
					// TO DO: TO use 3D secure method to authenticate user , uncomment below code , also ensure the this 3d secure feature is enable for your Merchant ID
